        ...
        <div className="w-full max-w-md space-y-6">
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 shadow-xl border border-slate-200/80 space-y-6">
            ...
            {!isForgotMode ? (
              ...
              <>
                <div>
                  ...
                  <p className="text-xs text-slate-500 mt-1.5 leading-relaxed">
                    Sign in to your registered resident account to access municipal services.
                  </p>
                </div>
              ...
              /* ── INLINE FORGOT PASSWORD FORM (STAYS WHERE FORM IS) ── */
              <div className="space-y-4">
                <div>
                  <button 
                    type="button"
                    onClick={() => setIsForgotMode(false)}
                    className="text-xs font-bold text-blue-600 hover:underline inline-flex items-center gap-1 mb-2"
                  >
                    ← Back to Sign in
                  </button>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-3 text-sm bg-slate-50 border-2 border-blue-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/30 text-slate-900 font-mono font-bold tracking-widest text-center"
                        />
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-10 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-600 text-slate-900 font-medium"
                        />
                        <button
                          type="button"
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-3 py-2.5 text-xs bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/20 text-slate-900 font-medium"
                        />
                      </div>
                    </div>
